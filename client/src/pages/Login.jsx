        ...
        <div className="bg-[#050d1b] border border-[#2c77d1]/20 rounded-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-[#2c77d1]/30 bg-[#050d1b] text-[#2c77d1] focus:ring-[#2c77d1]"
                />
                <span className="text-sm text-gray-300">Remember me</span>
              </label>
              <Link to="/forgot-password" className="text-sm text-[#2c77d1] hover:text-[#9426f4]">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-400">
              ...
              <Link to="/signup" className="text-[#2c77d1] hover:text-[#9426f4] font-semibold">
                Sign Up
              </Link>
            </p>
          </div>
          ...
          <div className="mt-6 relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#050d1b] text-gray-400">Or continue with</span>
            </div>
          </div>

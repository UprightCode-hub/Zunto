...
# Thresholds
RULE_MATCH_THRESHOLD = 0.75  # Minimum confidence to match a rule
BLOCK_THRESHOLD = 0.90       # Minimum confidence to block immediately
...
class RuleEngine:
    ...
    def __init__(self, rules_path: Optional[str] = None):
        """Initialize rule engine and load rules from YAML."""

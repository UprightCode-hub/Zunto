...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    BASE_DIR / 'frontend',  # includes frontend/assistant/assets/js and css
]
...
os.environ['TRANSFORMERS_CACHE'] = str(TEMP_DIR)
os.environ['HF_HOME'] = str(TEMP_DIR)
os.environ['SENTENCE_TRANSFORMERS_HOME'] = str(TEMP_DIR)

...
REGISTRATION_RESEND_COOLDOWN_SECONDS = config('REGISTRATION_RESEND_COOLDOWN_SECONDS', default=60, cast=int)

EMAIL_TASK_WARN_DURATION_MS = config('EMAIL_TASK_WARN_DURATION_MS', default=2000, cast=int)
EMAIL_ALERT_FAILURE_RATE_THRESHOLD = config('EMAIL_ALERT_FAILURE_RATE_THRESHOLD', default=0.05, cast=float)
EMAIL_ALERT_MIN_SAMPLES = config('EMAIL_ALERT_MIN_SAMPLES', default=50, cast=int)
...
urlpatterns = [
    ...
    path('api/recommendations/feedback/', views.recommendation_feedback_endpoint, name='recommendation_feedback'),
    ...
    path('api/admin/dispute-cases/', views.admin_dispute_cases, name='admin_dispute_cases'),
